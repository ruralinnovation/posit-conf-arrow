...
example_df <- dbGetQuery(con, "SELECT json_transform(j, '{\"family\": \"VARCHAR\", \"coolness\": \"DOUBLE\"}') FROM example;")
...
rural_places_tbl <- dbGetQuery(con, "SELECT features from rural_places")$features[[1]]

rural_places_tbl |> nrow()
# [1] 2882

rural_places_arrow <- rural_places_tbl |> to_duckdb() 
